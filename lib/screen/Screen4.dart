            ...
            children: [
              Container(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Center(child: TextCustom(text: "Xác thực OTP", color: Colors.black,fontWeight: FontWeight.w500,fontSize: 16,)),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(children: [
                  TextCustom(text: "Một mã xác thực đã được gửi tới sđt:", color: Color(0xFF28293D),fontSize: 16,),
                  SizedBox(height: 10,),
                  TextCustom(text: '+84868666888', color: Color(0xFFAE1730),fontSize: 16, fontWeight: FontWeight.w600,),
                  SizedBox(height: 20,),
                  ...
                  Pinput(
                    ...
                    defaultPinTheme: PinTheme(
                      ...
                      decoration: BoxDecoration(border: Border.all(color: Color(0xFFE3E3E3)),borderRadius: BorderRadius.circular(8))
